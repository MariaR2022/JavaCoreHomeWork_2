...
public class MainClass {
    public static void main(String[] args) {
        ...
        String[][] error_array = {{"1","2","3","4"},{"1","2","3","4"}};
        String[][] error_data = {{"1","1","3","4",},{"1","2","аа3","4"}, {"1","1","1","1"}, {"1","1","1","1"}};

        System.out.println("Начало работы программы");

        System.out.println("Корректные размер массива и значения его элементов");
        try {
            result = 0;
        ...
        System.out.println("Некорректное значение элемента массива");
        try {
            result = 0;
